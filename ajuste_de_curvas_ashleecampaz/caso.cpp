...
void caso_1_regresion(){
	...
	void caso_1_funcion_potencia(){
		cout<<"Caso 1 regresion cuadratica."<<endl;
	...
	void caso_1_regresion_cuadratica(){
		cout<<"Caso 1 linealizacion funcion potencia."<<endl;
		vector<double> x {0.0f,1.0f,2.0f,3.0f,4.0f,5.0f};
		vector<double> y {2.1f,7.7f,13.6f,27.2f,40.9,61.1f};
		vector<double> xlog10 = logD(x);
		double xi = 2.5f;
		double y_estimado;
		cuadratica c(x,y); 
